function Evaluacion(configuraciones, elementos) {
	this.configuraciones = configuraciones;
	this.elementos = elementos;
}
Evaluacion.prototype.ejecuta = function() {
...
Evaluacion.prototype.recibe_validacion = function(parametros) {

    this.elementos[0][parametros[0]] = parametros[1];

};	   						
Evaluacion.prototype.recibe_metodo = function(parametros) {

    this.configuraciones[1][3][parametros[0]] = parametros[1];

};	   						
Evaluacion.prototype.recibe_especial = function(posicion, posicion2, valor) {

    this.elementos[3][posicion][posicion2] = valor;
