...
//    private lateinit var viewModel: ScannViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main_scann)) { v, insets ->
        ...
        impresora.print(mutableListOf(mutableListOf(3, "0) INICIA ScannActivity.kt", false)))
...
//        viewModel = ViewModelProvider(this).get(ScannViewModel::class.java)
        ...
        /*
                ...
                /////////////////////////////////////////////////////////////////////////
        */
        val metodosScann = Metodos()

        metodosScann.agregarListaMetodos(
            ...
            parametros = mutableListOf(
                mutableListOf(this@ScannActivity),
                mutableListOf(this@ScannActivity)
            ),
        ...
        botonPaquetes.setOnClickListener {
            metodosScann.ejecutar_posicion(0)
        }
        ...
        botonRepositorios.setOnClickListener {
            metodosScann.ejecutar_posicion(1)
        }
