...
///////////////////////////////////////////////////////////////
// DEFINICIÓN DE COMBOITEM

/**
 * Data class para items de combobox
 * @property value Valor interno del item
 * @property text Texto visible del item
 */
...
// - Registra el evento de creación en LogCat
    ...
    init {
        ...
        obtenerImpresora().ruta[3] = "PaquetesTabla.kt"
        obtenerImpresora().ruta[3] = "init"
        obtenerImpresora().ruta[3] = ""
            ...
            withContext(Dispatchers.IO) {
                try {
                    ...
                    val paquetes = Paquetes(
                        ...
                        referencia = valores["referencia"] as String,
