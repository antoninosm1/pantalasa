/**
 * Ruta: sdhybca/app\src\main\java\com\pantalasa\sdhybca\LineActivity.kt
 * Descripción: Actividad para decidir modalidad de trabajo
 * Responsabilidades:
 * - Recibir la modalidad de trabajo OFFLINE o ONLINE
 */
...
//        val actividadOnlineLogin = Actividad(OnlineLoginActivity::class.java)
        val actividadEnConstruccion = Actividad(EnConstruccionActivity::class.java)
...
//                Pair("actividad_login", actividadOnlineLogin)
                Pair("actividad_construccion", actividadEnConstruccion)
            ),
