...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' INICIAMOS consulta_baja_detalle.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$lista_parametros = [];
$filtro = 1;
$lista_parametros[] = [0, [[0, "detalles.ID", 0, $id, 0]], 0];
...
$codigos = ['', '', [], '', '', ''];
$elemento01 = 'detalles.ID';
$elemento02 = 'CONCAT(detalles.MaterialId, " ", materiales.Desco, " ", materiales.Unidad)';
$elemento03 = 'detalles.Cant';
$elementos_campos_2 = [$elemento01, $elemento02, $elemento03];
$elementos_nombres_2 = ['dato_01', 'dato_02', 'dato_03'];
$elementos_tipos_2 = [1, 1, 1];
$elementos = [$elementos_campos_2, $elementos_nombres_2, $elementos_tipos_2];
$consultadetalles = new Consulta($configuraciones, $codigos, $elementos);

// EJECUTAMOS METODO construye() DEL OBJETO Consulta	
$consultadetalles->construye();

// EJECUTAMOS METODO ejecuta() DEL OBJETO Consulta	
$consultadetalles->ejecuta();

// CONCATENAMOS LA RESPUESTA JSON	
$respuestaJSON = $respuestaJSON.$consultadetalles->codigos[1].']';
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_baja_detalle.php RESPUESTA JSON:';
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' TERMINAMOS consulta_baja_detalle.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
