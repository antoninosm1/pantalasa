...
// PROGRAMA GENERAL PARA CONSULTAR REGISTROS DE COMUNIDAD
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' INICIAMOS consulta_comunidad.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'INICIAMOS consulta_comunidad.php ESTOS SON LOS VALORES: ';
$_SESSION['logPhp']->escribe_log();
...
$parametro01 = [0, [[0, "comunidad.usuario", 0, 1, 0]], 0];
...
if ($filtro_consulta==2) {
    $filtro = 1;
    $parametro01 = [0, [[0, "comunidad.usuario", 0, 0, 0]], 0];
}
...
if ($orden_consulta==1) {
    $order_elementos = ['comunidad.id'];
}
if ($orden_consulta==2) {
    $order_elementos = ['comunidad.nombre', 'comunidad.apellido', 'comunidad.alias'];
}
if ($orden_consulta==3) {
    $order_elementos = ['comunidad.apellido', 'comunidad.nombre', 'comunidad.alias'];
}
if ($orden_consulta==4) {
    $order_elementos = ['comunidad.alias', 'comunidad.nombre', 'comunidad.apellido'];
}
...
$registros = 0;
$excel = [0, '', 0, '', '', '', '', ''];
$nombre = 'INST:: consulta_comunidad';
...
$consulta_total_comunidad = new Consulta($configuraciones, $codigos, $elementos);

// EJECUTAMOS METODO construye() DEL OBJETO Consulta	
$consulta_total_comunidad->construye();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_comunidad.php ESTA ES LA CONSULTA COUNT:';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_total_comunidad->codigos[0];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$consulta_total_comunidad->ejecuta();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_comunidad.php ESTA ES LA RESPUESTA COUNT:';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_total_comunidad->codigos[1];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$limites = [1, $posicion_inicio, 200, $consulta_total_comunidad->obtener_dato_lote(0, 0, $posicion_inicio, $porcion), $consulta_total_comunidad->obtener_status(0, 0, $posicion_inicio, $porcion), $inicial_lote];
$registros = 0;
...
$elementos_campos = ['comunidad.id', 'comunidad.nombre', 'comunidad.apellido', 'comunidad.alias', 'comunidad.usuario', 'comunidad.fecha', 'comunidad.creador'];
$elementos_nombres = ['dato_01', 'dato_02', 'dato_03', 'dato_04', 'dato_05', 'dato_06', 'dato_07'];
$elementos_tipos = [1, 1, 1, 1, 1, 1, 1];
$elementos = [$elementos_campos, $elementos_nombres, $elementos_tipos];
$consulta_comunidad = new Consulta($configuraciones, $codigos, $elementos);
// EJECUTAMOS METODO ejecuta_rangos() DEL OBJETO Consulta	
$consulta_comunidad->ejecuta_rangos();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_comunidad.php ESTA ES LA CONSULTA:';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_comunidad->codigos[0];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$respuestaJSON = $respuestaJSON.$consulta_comunidad->codigos[1].']';
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_comunidad.php ESTA ES LA RESPUESTA:';
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' TERMINAMOS consulta_comunidad.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
