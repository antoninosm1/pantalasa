...
//require_once "../../pantalib/php/objetos/new/Conexion_comerciosolidario.php";
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' INICIAMOS enviar_mail_usuario.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$host = 'smtp.gmail.com';
$username = 'software.pantalasa@gmail.com';
$password = 'klyjdnmhutciznrh';
$set = 'COMERCIO SOLIDARIO';
$subject = 'Actualizar Cuenta COMERCIO SOLIDARIO';
$body = '<p>Ingresa al siguiente enlace para actualizar tu cuenta de usuario del sistema COMERCIO SOLIDARIO:</p><a href="'.$ruta.'php/prepara_actualiza_clave.php?token='.urlencode($token).'&expira='.urlencode($token_expira).'">Actualizar Cuenta</a><br>El enlace expira en: '.$token_expira;
...
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' enviar_mail_usuario.php RESPUESTA JSON';
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' TERMINAMOS enviar_mail_usuario.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
