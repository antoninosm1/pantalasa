...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' INICIAMOS consulta_kanban_cajas.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'INICIAMOS consulta_kanban_cajas.php ESTOS SON LOS VALORES: ';
$_SESSION['logPhp']->escribe_log();
...
$registros = 0;
$excel = [0, '', 0, '', '', '', '', ''];
$nombre = 'INST:: consulta_total_kanban_cajas';
...
$consulta_total_kanban_cajas = new Consulta($configuraciones, $codigos, $elementos);

// EJECUTAMOS METODO construye() DEL OBJETO Consulta	
$consulta_total_kanban_cajas->construye();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_kanban_cajas.php ESTA ES LA CONSULTA COUNT:';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_total_kanban_cajas->codigos[0];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$consulta_total_kanban_cajas->ejecuta();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_kanban_cajas.php ESTA ES LA RESPUESTA COUNT:';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_total_kanban_cajas->codigos[1];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
///////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////
// HACEMOS INSTANCIA DEL OBJETO Consulta PARA CONSULTA PUNTOS CON CAJA	
///////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////

$numero_elementos = 4;
$tables = ['puntos INNER JOIN usuarios ON puntos.creador = usuarios.id'];
$where = [1, $lista_parametros]; 
$order_order = 1;
$order_elementos = ['puntos.nombre'];
$order = [1, $order_order, $order_elementos];
...
$limites = [1, $posicion_inicio, 200, $consulta_total_kanban_cajas->obtener_dato_lote(0, 0, $posicion_inicio, $porcion), $consulta_total_kanban_cajas->obtener_status(0, 0, $posicion_inicio, $porcion), $inicial_lote];
$registros = 0;
...
$excel = [0, '', 1, '', '', '', '', ''];
$nombre = 'INST:: consulta_kanban_cajas';
$recupera = 0;
...
$codigos = ['', '', [], '', '', ''];
$elementos_campos = ['puntos.id', 'puntos.nombre', 'puntos.status', 'CONCAT(usuarios.nombre, " ", usuarios.paterno, " ", usuarios.materno)'];
$elementos_nombres = ['dato_01', 'dato_02', 'dato_03', 'dato_04'];
$elementos_tipos = [1, 1, 1, 1];
$elementos = [$elementos_campos, $elementos_nombres, $elementos_tipos];
$consulta_kanban_cajas = new Consulta($configuraciones, $codigos, $elementos);
// EJECUTAMOS METODO ejecuta_rangos() DEL OBJETO Consulta	
$consulta_kanban_cajas->ejecuta_rangos();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = $consulta_kanban_cajas->codigos[0];
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$respuestaJSON = $respuestaJSON.$consulta_kanban_cajas->codigos[1].']';
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_kanban_cajas.php ESTA ES LA RESPUESTA:';
$_SESSION['logPhp']->escribe_log();
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' TERMINAMOS consulta_kanban_cajas.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
