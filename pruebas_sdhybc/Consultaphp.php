<?php
// DEFINICION DE LA CLASE Consultaphp
	class Consultaphp
    ...
    public function ejecuta() 
        {
            ...
            if ($this->configuraciones[7]==1) {
                ...
                while($row = $resultado -> fetch_array()) {
                    ...
                    $_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' Consulta.php. METODO: ejecuta()';
                    $_SESSION['logPhp']->escribe_log();
                    $_SESSION['logPhp']->configuraciones[1] = 'ESTA ES EL RESULTADO DE LA CONSULTA: '.$row[0];
                    $_SESSION['logPhp']->escribe_log();
                    $_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
                    $_SESSION['logPhp']->escribe_log();
