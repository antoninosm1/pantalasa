function Gradilla(configuraciones, etiquetas, codigos, elementos) {
...
Gradilla.prototype.generahtml = function() {
/////////////////////////////////////////////////////////////////////
////////// ANALIZAMOS DIMESIONES DEL NAVEGADOR Y CONFIGURACIONES DE BREAKS DE LA GRADILLA
////////// PARA ESTABLECER ORIENTACIÓN DE LA GRADILLA
...
/////////////////////////////////////////////////////////////////////
////////// INICIAMOS EL DIV CONTENEDOR DE GRADILLA COMO DIV PRINCIPAL
    this.codigos[0] = '<DIV CLASS = "'+this.etiquetas[0]+'" ID = "'+this.etiquetas[1]+'">';

/////////////////////////////////////////////////////////////////////
////////// INICIAMOS EL DIV CONTENEDOR DEL TITULO DE LA GRADILLA DENTRO DEL DIV PRINCIPAL
    this.codigos[0] = this.codigos[0]+'<DIV CLASS = "'+this.etiquetas[0]+'_titulogradilla" ID = "'+this.etiquetas[1]+'_TITULOGRADILLA">';
/////////////////////////////////////////////////////////////////////
////////// CONCATENAMOS EL TITULO DE LA GRADILLA DENTRO DEL DIV CONTENEDOR DEL TITULO DE LA GRADILLA
    this.codigos[0] = this.codigos[0]+this.configuraciones[5];
/////////////////////////////////////////////////////////////////////
////////// CERRAMOS EL DIV CONTENEDOR DEL TITULO DE LA GRADILLA DENTRO DEL DIV PRINCIPAL
    this.codigos[0] = this.codigos[0]+'</DIV>';

/////////////////////////////////////////////////////////////////////
////////// INSPECCIONAMOS SI LA ORIENTACION DE LA GRADILLA ES 0 = VERTICAL 1 = HORIZONTAL
    ...
    var total_registros_gradilla = (this.configuraciones[3].codigos[0][0].length-1)
    if (total_registros_gradilla > 0) {
        ...
        while(i < (this.configuraciones[4][0]+this.configuraciones[4][1])) {
            ...
            while(ii < this.configuraciones[1]) {
                if (this.configuraciones[6][0]==0) {
                    ...
                    this.codigos[0] = this.codigos[0] + '<DIV  CLASS = "'+this.etiquetas[0]+'_celda '+this.etiquetas[0]+'_'+this.elementos[2][ii]+'_vertical" '; 
                    ...
                    this.codigos[0] = this.codigos[0] + '<DIV  CLASS = "'+this.etiquetas[0]+'_celda '+this.etiquetas[0]+'_'+this.elementos[2][ii]+'" '; 
                    this.codigos[0] = this.codigos[0] + 'ONCLICK="'+this.configuraciones[8][6]+'(`';
                    var iii = 0;
                    while(iii < this.configuraciones[8][7][0].length) {
                        if (this.configuraciones[8][7][0][iii]==0) {
...
/////////////////////////////////////////////////////////////////////
////////// CERRAMOS EL DIV CONTENEDOR DE GRADILLA O DIV PRINCIPAL
    this.codigos[0] = this.codigos[0]+'</DIV>';
};
Gradilla.prototype.imprimehtml = function() {
...
Gradilla.prototype.escribehtml = function() {
	$(this.etiquetas[2]).html(this.codigos[0]);
};	   						
Gradilla.prototype.agregahtml = function() {
	$(this.etiquetas[2]).append(this.codigos[0]);
};	   						
Gradilla.prototype.esArray = function(variable) {
    return Array.isArray(variable);
};
Gradilla.prototype.avanza = function() {
...
Gradilla.prototype.inicializa_posicion = function() {
    this.configuraciones[4][0] = 0;
};
Gradilla.prototype.retrocede = function() {
...
Gradilla.prototype.finaliza_posicion = function() {
    var num_pag_grid = this.configuraciones[3].codigos[0][0][0].registros / this.configuraciones[4][1];
    var num_pag_grid_int = Math.trunc(num_pag_grid);
...
Gradilla.prototype.actualiza_valores = function(valor_clave, valor_posicion, valor_celda) {
...
Gradilla.prototype.recibe_consulta = function(consulta) {
