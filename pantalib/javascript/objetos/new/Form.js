...
Form.prototype.valida = function() {
    alert('ESTOY EN METODO VALIDA DEL FORMULARIO');
    ...
    alert('TERMINO EN METODO VALIDA DEL FORMULARIO');
};	   						
Form.prototype.envia = function() {
    alert('ESTOY EN METODO ENVIA DEL FORMULARIO');
    ...
    alert('TERMINO METODO ENVIA DEL FORMULARIO');
};	   						
Form.prototype.envia_status = function() {
    alert('COMIENZA METODO ENVIA STATUS DEL FORMULARIO');
    if (this.configuraciones[5][0]==1) {
    ...
    alert('TERMINO METODO ENVIA STATUS DEL FORMULARIO');
};	   						
...
Form.prototype.revisa_data = function(data) {
    alert('COMIENZA METODO REVISA DATA');
    ...
    alert('TERMINA METODO REVISA DATA');
};	   						
    
Form.prototype.revisa_data_status = function(data) {
    alert('COMIENZA METODO REVISA DATA STATUS DEL FORMULARIO');
    if (data[0].registros==0) {
    ...
    alert('TERMINA METODO REVISA DATA STATUS DEL FORMULARIO');
