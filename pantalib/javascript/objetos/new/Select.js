function Select(configuraciones, etiquetas, codigos, elementos, valores, metodos) {
...
Select.prototype.generahtml = function() {
...
Select.prototype.imprimehtml = function() {
...
Select.prototype.escribehtml = function() {
	$(this.etiquetas[2]).html(this.codigos[0]);
};	   						
Select.prototype.agregahtml = function() {
	$(this.etiquetas[2]).append(this.codigos[0]);
};	   						
Select.prototype.traduce = function(par_idioma) {
    this.configuraciones[0][0] = par_idioma;
};	   						
Select.prototype.generahtml_consulta = function(data) {
...
// CALLBACK    
    var i = 0;
    while (i < this.configuraciones[11][1][this.configuraciones[11][0]].length) {
        eval(this.configuraciones[11][1][this.configuraciones[11][0]][i]);
        i++;
    }

};	   						
Select.prototype.actualizavalor = function() {
...
Select.prototype.recibefiltro = function(posicion, valor, valor_todos) {
    var i = 0;
...
Select.prototype.borra_area = function() {
	$(this.etiquetas[2]).html('');
};	   						
Select.prototype.cambia_area = function() {
};	   						
Select.prototype.recorta_filtro = function(recortes) {
...
Select.prototype.inicializa_valor = function() {
    this.valores[1] = this.valores[0];
};	   						
Select.prototype.seleccion = function(valor) {
//    alert('ESTOY EN SELECCION, ESTE ES EL VALOR: '+valor);
    this.valores[1] = valor;
};	   						
Select.prototype.posicion_callback = function(posicion) {
    this.configuraciones[11][0] = posicion;
};	   						
Select.prototype.buscador = function() {
	$('#'+this.etiquetas[1]).select2();
};	   						
