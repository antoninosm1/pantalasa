function Opciones(configuraciones, etiquetas, codigos, elementos) {
...
Opciones.prototype.generahtml = function() {
...
Opciones.prototype.imprimehtml = function() {
...
Opciones.prototype.escribehtml = function() {
	$(this.etiquetas[2]).html(this.codigos[0]);
};	   						
Opciones.prototype.agregahtml = function() {
	$(this.etiquetas[2]).append(this.codigos[0]);
};	   						
Opciones.prototype.traduce = function(par_idioma) {
    this.configuraciones[0][0] = par_idioma;
};	   						
Opciones.prototype.generahtml_status = function() {
    var posicion = 0;
    var i = 0;
...
Opciones.prototype.recibe_area_impresion = function(areaImpresion) {
    alert(areaImpresion);
