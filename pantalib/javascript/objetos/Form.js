function Form(especificaciones, campos, html) {
...
Form.prototype.validaForm = function() {
	var obligatorios = 0;
...
Form.prototype.grabaForm = function() {
...
/*		alert("voy a entrar al ciclo para armar los parametros"); */
		...
		for (var contador = 0; contador < this.campos[0].length; contador++) {
			...
			if (this.campos[5][contador]==1) {
				DatosForm.append(this.campos[0][contador], document.getElementById(this.campos[2][contador]).value);
			}
			if (this.campos[5][contador]==3) {
				var ValorFile = $("#"+this.campos[2][contador]).prop('files')[0];
				DatosForm.append(this.campos[0][contador], ValorFile);
			}
		}
		$.ajax({
...
Form.prototype.procesaForm = function() {
	let DatosForm = new FormData();
	if (this.especificaciones[4] == 1) {
...
Form.prototype.buscaForm = function() {
	let DatosForm = new FormData();
	if (this.especificaciones[4] == 1) {
...
Form.prototype.avanzaForm = function() {
...
Form.prototype.Formenvia = function() {
