...
Menu.prototype.recibe_area_impresion = function(areaImpresion) {
    alert(areaImpresion);
	this.etiquetas[2] = areaImpresion;
};	   						

Menu.prototype.recibe_status = function(status_nivel, posicion_elemento, status_elemento) {
	this.configuraciones[4][2][status_nivel][posicion_elemento] = status_elemento;
};	   						
