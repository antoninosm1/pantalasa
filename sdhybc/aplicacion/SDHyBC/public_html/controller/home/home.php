<?php
    ...
    //echo json_encode(array('success' => false, 'title' => 'ERROR', 'message' => $_POST['action']));
    
    switch ($_POST['action']) {
        case 'update-table':
            //echo json_encode(array('success' => false, 'title' => 'ERROR', 'message' => $_POST['page']));
    ...
    function update_table($page) {
        ...
        //echo json_encode(array('success' => false, 'title' => 'ERROR', 'message' => $page));
        ...
        if ($result != null) {
            foreach ($result as $row) {
                $output[] = array('ID' => $row['ID'], 'UsuarioId' => $row['UsuarioId'], 'MunicipioNom' => $row['MunicipioNom'], 'FecRegCed' => $row['FecRegCed'], 'FecRegViv' => $row['FecRegViv'], 'FecRegGen' => $row['FecRegGen']);
            }
        }
        mysqli_close($conn);
    ...
    function edit_record($id) {
        ...
        $_SESSION['url'] = "http://sdhybc/on/c_cedula.php";
    ...
    function show_ced($id) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $content = "<p class='font-size-12px'>" . 
                ...
                "<b class='font-size-12px'>Duración a Sede en Vehiculo:</b> " . $row['SedeVm'] .  "<br>" .
                "<b class='font-size-12px'>Distancia a Sede en Vehiculo:</b> " . $row['SedeVk'] .  "<br>" .
                "<b class='font-size-12px'>Duración a Sede a Pie:</b> " . $row['SedePm'] .  "<br>" .
                "<b class='font-size-12px'>Distancia a Sede a Pie:</b> " . $row['SedePk'] .  "<br>" .
                "<b class='font-size-12px'>Duración a Subsede en Vehiculo:</b> " . $row['SubsVm'] .  "<br>" .
                "<b class='font-size-12px'>Distancia a Subsede en Vehiculo:</b> " . $row['SubsVk'] .  "<br>" .
                "<b class='font-size-12px'>Duración a Subsede a Pie:</b> " . $row['SubsPm'] .  "<br>" .
                "<b class='font-size-12px'>Distancia a Subsede a Pie:</b> " . $row['SubsPk'] .  "<br>" .
                $row['FecRegCed'] . "</p>";
