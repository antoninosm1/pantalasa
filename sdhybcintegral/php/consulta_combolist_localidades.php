...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' INICIAMOS consulta_combolist_localidades.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
...
$respuestaJSON = '[';
$lista_parametros = [];
$lista_parametros[] = [0, [[0, "localidades.MunicipioNom", 0, $municipio_filtro, 0]], 0];
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'consulta_combolist_localidades_cedulas.php ESTOS SON LOS VALORES:';
$_SESSION['logPhp']->escribe_log();
...
///////////////////////////////////////////////////////////////
    ...
    $order_order = 1;
    $order_elementos = ['localidades.MunicipioNom', 'localidades.LocalidadNom'];
    ...
    $codigos = ['', '', [], '', '', ''];
    $elementos_campos = ['COUNT(DISTINCT MunicipioNum, MunicipioNom, LocalidadNum, LocalidadNom)'];
...
// SEXTA POSICIÓN INDICA CONSULTA INICIAL DE UN LOTE DE CONSULTAS 0 = INICIAL, 1 = NO INICIAL 
    ...
    $registros = 0;
    $excell = [0, '', 0, '', '', '', '', ''];
    $nombre = 'INST:: consultalocalidades';
    $recupera = 0;
    ...
    $codigos = ['', '', [], '', '', ''];
    $elementos_campos = ['DISTINCT MunicipioNum', 'MunicipioNom', 'LocalidadNum', 'LocalidadNom'];
    $elementos_nombres = ['numero_municipio', 'nombre_municipio', 'numero_localidad', 'nombre_localidad'];
    $elementos_tipos = [1, 1, 1, 1];
    $elementos = [$elementos_campos, $elementos_nombres, $elementos_tipos];
    $consultalocalidades = new Consulta($configuraciones, $codigos, $elementos);

// EJECUTAMOS METODO ejecuta() DEL OBJETO Consulta	
    $consultalocalidades->ejecuta_rangos();

// HACEMOS CONCATENACIÓN FINAL

    $consultalocalidades->codigos[1] = "[".$consultalocalidades->codigos[1]."]";

// RETORNAMOS VARIABLE codigos[1] DEL PRIMER OBJETO Consulta	
    echo $consultalocalidades->codigos[1];
...
//$_SESSION['logPhp']->escribe_log();
//$_SESSION['logPhp']->configuraciones[1] = $consultalocalidades->codigos[1];
//$_SESSION['logPhp']->escribe_log();
//$_SESSION['logPhp']->configuraciones[1] = ' ';
//$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = 'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
...
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').' TERMINAMOS consulta_combolist_localidades.php';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->configuraciones[1] = date('Y-m-d H:i:s').'XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX';
$_SESSION['logPhp']->escribe_log();
$_SESSION['logPhp']->escribe_log();
