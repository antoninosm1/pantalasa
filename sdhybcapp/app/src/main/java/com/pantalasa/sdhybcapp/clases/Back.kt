package com.pantalasa.sdhybcapp.clases
...
// Ubicado dentro de la clase Back
    ...
    suspend fun verificarConexion() {
        ///////////////////////////////////////////////////////////////
        // BLOQUE 1: VERIFICACIÓN DE CONECTIVIDAD EN SEGUNDO PLANO
        val resultado = withContext(Dispatchers.IO) {
            try {
                ///////////////////////////////////////////////////////////////
                // BLOQUE 1.1: OBTENER SERVICIO DE CONECTIVIDAD
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    ...
                    cm.getNetworkCapabilities(network)?.let { capabilities ->
                        // Verifica capacidades esenciales de conexión
                ...
                // BLOQUE 1.3: LÓGICA PARA VERSIONES ANTERIORES
                    ...
                    // Usamos isConnected en lugar del más deprecado isConnectedOrConnecting
                    activeNetwork?.isConnected == true
                }
            } catch (e: Exception) {
                ///////////////////////////////////////////////////////////////
                // BLOQUE 1.4: MANEJO DE ERRORES
                false
            }
        }
